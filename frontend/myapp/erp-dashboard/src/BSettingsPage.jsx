...
const tabs = ["Business Profile", "Account", "Preferences", "Data", "Security", "Verification"];
...
export default function BSettingsPage({
  ...
  const [internalTab, setInternalTab] = useState(activeTab || "Business Profile");
  ...
  return (
    <div style={{ ...ibm }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
        <div>
          ...
          <p style={{ margin: "0 0 0 13px", color: C.textDim, fontSize: 12, letterSpacing: "0.5px" }}>
            Manage your business, account and application preferences
          </p>
        </div>
        <button style={{
          padding: "10px 18px",
        ...
        {tabs.map(tab => (
          <button
            ...
            style={{
              ...
              fontSize: 12,
              cursor: "pointer",
              border: `1px solid ${currentTab === tab ? C.green : C.border}`,
              background: currentTab === tab ? C.green : C.card,
              color: currentTab === tab ? "#fff" : C.textDim,
              fontFamily: "'IBM Plex Sans', sans-serif",
              fontWeight: 600,
              transition: "all .12s",
            }}
      ...
      {currentTab === "Business Profile" && (
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 18 }}>
          ...
          <div style={{ background: C.card, borderRadius: 12, padding: "24px", border: `1px solid ${C.border}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
            <div style={{ ...syne, fontSize: 15, fontWeight: 700, color: C.text, marginBottom: 18 }}>Business Details</div>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
              <div>
                <label style={labelStyle()}>Business Name</label>
                <input defaultValue="Smart ERP Business" style={inputStyle()} />
              </div>
              <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
              <div>
                ...
                <input defaultValue="business@email.com" style={inputStyle()} />
              </div>
              <div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input defaultValue="Business address" style={inputStyle()} />
            </div>

            <div>
              <label style={labelStyle()}>Business Description</label>
              <textarea defaultValue="Business description" style={textareaStyle()} />
            </div>
          </div>
          ...
          <div style={{ background: C.cardGreen, borderRadius: 12, padding: "24px", border: `1px solid ${C.greenBorder}`, boxShadow: "0 1px 4px rgba(74,122,73,0.08)" }}>
            ...
            <div style={{ display: "grid", gap: 12 }}>
              <div style={summaryCardStyle()}>
                <div style={{ fontSize: 11, color: C.textDim }}>Business Type</div>
                <div style={{ fontSize: 13, fontWeight: 700, color: C.text, marginTop: 4 }}>General Business</div>
              </div>
              <div style={summaryCardStyle()}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
          ...
          <div style={{ background: C.card, borderRadius: 12, padding: "24px", border: `1px solid ${C.border}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input defaultValue="Business Admin" style={inputStyle()} />
            </div>
          ...
          <div style={{ background: C.card, borderRadius: 12, padding: "24px", border: `1px solid ${C.border}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
            ...
            <div style={{ display: "grid", gap: 14 }}>
              ...
              <ToggleRow label="Sales Alerts" value={accountToggles.salesAlerts} onToggle={() => toggleAccount("salesAlerts")} />
              <ToggleRow label="Inventory Alerts" value={accountToggles.inventoryAlerts} onToggle={() => toggleAccount("inventoryAlerts")} />
              <ToggleRow label="Supplier Updates" value={accountToggles.supplierUpdates} onToggle={() => toggleAccount("supplierUpdates")} />
          ...
          <div style={{ background: C.card, borderRadius: 12, padding: "24px", border: `1px solid ${C.border}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              ...
              <div>
                ...
                <input defaultValue="Asia/Calcutta" style={inputStyle()} />
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gap: 18 }}>
            ...
            <div style={{ background: C.dangerBg, borderRadius: 12, padding: "24px", border: "1px solid #f2bcbc", boxShadow: "0 1px 4px rgba(200,48,48,0.06)" }}>
              ...
              <div style={{ fontSize: 12, color: C.textMuted, marginBottom: 16 }}>
                Deactivate account or remove business workspace permanently.
              </div>
      ...
      {currentTab === "Verification" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
          <div style={{ background: C.card, borderRadius: 12, padding: "24px", border: `1px solid ${C.border}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
            <div style={{ ...syne, fontSize: 15, fontWeight: 700, color: C.text, marginBottom: 18 }}>GST Verification</div>
            <div style={{ display: "grid", gap: 16 }}>
              <div>
                <label style={labelStyle()}>GSTIN</label>
                <input value={gstin} onChange={(e) => setGstin(e.target.value)} placeholder="Enter GSTIN" style={inputStyle()} />
              </div>
              <div>
                <label style={labelStyle()}>GST Document</label>
                <input type="file" accept=".pdf,.png,.jpg,.jpeg" onChange={(e) => {
                  const file = e.target.files?.[0];
                  setGstDocument(file ? file.name : "");
                  if (file) {
          ...
          <div style={{ background: C.cardGreen, borderRadius: 12, padding: "24px", border: `1px solid ${C.greenBorder}`, boxShadow: "0 1px 4px rgba(74,122,73,0.08)" }}>
            <div style={{ ...syne, fontSize: 15, fontWeight: 700, color: C.green, marginBottom: 18 }}>Verification Status</div>
            <div style={summaryCardStyle()}>
              <div style={{ fontSize: 11, color: C.textDim }}>Current status</div>
              <div style={{ fontSize: 16, fontWeight: 700, color: C.text, marginTop: 6 }}>{verificationStatus}</div>
            </div>
            <div style={{ fontSize: 12, color: C.textMuted, marginTop: 12 }}>
              {gstDocument ? `Uploaded: ${gstDocument}` : "Upload your GST document to move to pending review."}
            </div>
          </div>
        </div>
      )}
